...
\begin{frame}{Mesh Architecture Under Observation}
  ...
  \begin{tikzpicture}[
      ...
      svc/.style={draw, rounded corners, minimum width=2.4cm, minimum height=0.9cm, align=center, fill=blue!8},
      ext/.style={draw, rounded corners, minimum width=2.4cm, minimum height=0.9cm, align=center, fill=green!10}
    ]
  ...
  \vspace{0.4cm}
  \begin{center}
  Every hop is an Envoy sidecar call: Prometheus scrapes metrics, Jaeger\\
